...
def get_model(point_clouds, is_training, bn_decay=None, weight_decay=None):
    ...
    l1_xyz, l1_points, _ = pu.pointnet_sa_module_decay(l0_xyz, l0_points, npoint=512, radius=None, nsample=16, mlp=[64, 128, 512], mlp2=None,
    ...
    l2_xyz, l2_points, _ = pu.pointnet_sa_module_decay(l1_xyz, l1_points, npoint=256, radius=None, nsample=8, mlp=[256, 256, 512], mlp2=None,
                                                 group_all=False, is_training=is_training, bn_decay=bn_decay, weight_decay=weight_decay,
                                                 scope='layer2', knn=True)
    # layer3: (batch_size, 1, 512)
    l3_xyz, l3_points, _ = pu.pointnet_sa_module_decay(l2_xyz, l2_points, npoint=None, radius=None, nsample=None, mlp=[256, 512, 1024], mlp2=None,
    ...
    lk_points = pu.up_down_up_folding(lk_points, 2, grid_88_64, 4, 8, scope='layerk_up_down_up', bn_decay=bn_decay,
                              weight_decay=weight_decay, is_training=is_training)
    ...
    # several res-like layer will help to further improve the performance.
