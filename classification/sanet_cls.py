...
def get_model(point_clouds, is_training, bn_decay=None, weight_decay=None):
    ...
    l1_xyz, l1_points, _ = pu.pointnet_sa_module_decay(l0_xyz, l0_points, npoint=512, radius=None, nsample=64, mlp=[64, 64, 128], mlp2=None,
    ...
    l2_xyz, l2_points, _ = pu.pointnet_sa_module_decay(l1_xyz, l1_points, npoint=256, radius=None, nsample=64, mlp=[128, 128, 256], mlp2=None,
                                                 group_all=False, is_training=is_training, bn_decay=bn_decay, weight_decay=weight_decay,
